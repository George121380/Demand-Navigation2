...
# prompt+="""1. I want to enjoy some time in the sun, perhaps some outdoor furniture would be ideal.
...
example_explain="""Above is the format of the answer. In the "basic demand" you need to summarize and distill my basic demand.  And in the "normal items" you need to list all the items that are related to my demand or can probably fulfill my basic demand. In the "preference" you need to summarize and distill my preference. And in the "prefered items" you need to list all the items in the "normal items" that can probably fulfill my preference.\n"""
